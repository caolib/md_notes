...
# [计算机网络](https://htmlpreview.github.io/?https://github.com/TankingCao/note/blob/master/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C.html)
...
> <mark>**计算机网络就是以传输信息为基本目的，用通信线路和通信设备将多个计算机连接起来的计算机系统的集合**</mark>
...
<img src="https://gitee.com/clibin/image-bed/raw/master/CopyQ.TZiqFW.png" alt="计算机网络分类" title='计算机网络的分类' />
...
<img src="https://gitee.com/clibin/image-bed/raw/master/image-20231024224626941.png" title="网络" style="zoom:80%;" />

2. <mark>互连网络</mark>（internet，通用名词，注意和 Internet互联网 区分）

> 将网络用路由器连接起来就成了互连网络，因此互连网络是<mark>网络的网络</mark>

<img src="https://gitee.com/clibin/image-bed/raw/master/image-20231024224534363.png" title="互连网络就是网络的网络" style="zoom:80%;" />
...
<img src="https://gitee.com/clibin/image-bed/raw/master/image-20231024224804841.png" title="woc,O" style="zoom: 67%;" />
...
<img src="https://gitee.com/clibin/image-bed/raw/master/image-20231024225143618.png" title="ISP结构的互联网" style="zoom: 67%;"/>
...
> 3. 一般来说，表示速率时<mark>$$k = 10^{3}$$</mark>,表示数据时，<mark>$$k = 2^{10}$$</mark>
...
> 2. <span style='color: #ff6b6b'>协议</span>：<mark>**控制两个或多个对等实体之间通信的规则的集合**</mark>
...
- **以下情况<mark>不应发送ICMP差错报告报文</mark>**：
  ...
  - 对具有<mark>特殊地址</mark>（例如`127.0.0.0`或`0.0.0.0`）的IP数据报不发送CMP差错报告报文。
...
<mark>**CRC** (Cyclical Redundancy Check) 循环冗余校验</mark>
